...
namespace
{
    ...
    void Apply(const char* key, const char* val)
    {
        ...
        else if (KeyIs(key, "hold_raised_fy"))     g_cfg.holdRaisedFy      = (float)atof(val);
        else if (KeyIs(key, "hold_exit_fx"))       g_cfg.holdExitFx        = (float)atof(val);
        else if (KeyIs(key, "hold_exit_fy"))       g_cfg.holdExitFy        = (float)atof(val);
        ...
        else if (KeyIs(key, "recenter_fy"))        g_cfg.recenterFy        = (float)atof(val);
