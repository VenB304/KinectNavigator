' KinectNavigator-Setup.vbs - flash-free launcher for the setup window.
'
' Double-click this (or KinectNavigator-Setup.bat, which just calls it) to open the
...
cmd = "powershell.exe -NoProfile -ExecutionPolicy Bypass -WindowStyle Hidden -File """ & _
      here & "\KinectNavigator-Setup.ps1"""
